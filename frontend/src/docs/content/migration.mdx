...
Download the current desktop application from [Installation](/installation). Existing npm users may also run:
...
<Cards>
	<Card title="Installation" href="/installation" description="Install the current desktop build." />
	<Card title="Architecture" href="/architecture" description="Understand the current Go/Electron design." />
	<Card title="Troubleshooting" href="/troubleshooting" description="Resolve migration and startup problems." />
</Cards>
