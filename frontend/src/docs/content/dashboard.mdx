...
<Cards>
	<Card title="Quickstart" href="/quickstart" description="Create and follow the first worker session." />
	<Card title="Architecture" href="/architecture" description="Understand the daemon, storage, events, and controller modes." />
	<Card title="Examples" href="/examples" description="Try practical desktop and CLI workflows." />
</Cards>
