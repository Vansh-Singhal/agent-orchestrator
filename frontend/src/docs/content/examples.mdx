...
<Cards>
	<Card title="Quickstart" href="/quickstart" description="Run the first desktop workflow." />
	<Card title="Dashboard" href="/dashboard" description="Understand each desktop surface used above." />
	<Card title="Troubleshooting" href="/troubleshooting" description="Recover when a workflow does not behave as expected." />
</Cards>
