...
See [Projects](/configuration/projects) for the current field reference.
...
Do not set `HOST=0.0.0.0` or proxy the primary daemon to a network. For phone access, use the separate authenticated listener created by **Connect Mobile**. See [Remote access](/configuration/remote-access).
...
<Cards>
	<Card title="Projects" href="/configuration/projects" description="Configure one project and its session roles." />
	<Card title="Lifecycle automation" href="/configuration/lifecycle-automation" description="Understand built-in CI, review, and merge-conflict handling." />
	<Card title="Remote access" href="/configuration/remote-access" description="Pair the native mobile app safely." />
</Cards>
