...
<Cards>
	<Card title="CI recovery" href="/guides/ci-recovery" description="Follow the built-in CI feedback loop." />
	<Card title="Review loop" href="/guides/review-loop" description="Work with GitHub feedback and AO reviewer agents." />
</Cards>
