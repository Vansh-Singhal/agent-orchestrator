...
<Callout type="info" title="Before you start">
	Install AO, authenticate `gh` for a GitHub project, and sign in to one supported agent harness. See [Installation](/installation).
</Callout>
...
<Cards>
	<Card title="Dashboard" description="Learn the board, session view, inspector, Chat, and terminal." href="/dashboard" />
	<Card title="Architecture" description="See how the desktop app and daemon coordinate sessions." href="/architecture" />
	<Card title="Examples" description="Try current desktop and CLI workflows." href="/examples" />
</Cards>
