...
<Cards>
	<Card title="Dashboard" href="/dashboard" description="See how these capabilities appear in the desktop app." />
	<Card title="Platforms" href="/platforms" description="Understand desktop and mobile platform behavior." />
	<Card title="Troubleshooting" href="/troubleshooting" description="Diagnose daemon, controller, terminal, and SCM problems." />
</Cards>
