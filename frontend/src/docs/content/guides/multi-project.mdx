...
<Cards>
	<Card title="Projects" href="/configuration/projects" description="Current typed project settings." />
	<Card title="Connect Mobile" href="/configuration/remote-access" description="Pair the native mobile app." />
</Cards>
