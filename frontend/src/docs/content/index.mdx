...
<Callout type="info" title="Fastest path">
	Download the desktop app, add a repository, and start one small session. See [Installation](/installation), then [Quickstart](/quickstart).
</Callout>
...
<Cards>
	<Card title="Installation" description="Download the desktop app and connect your tools." href="/installation" />
	<Card title="Quickstart" description="Run one worker session from task to pull request." href="/quickstart" />
	<Card title="Dashboard" description="Learn the desktop board, session view, Chat, terminal, and inspector." href="/dashboard" />
	<Card title="Architecture" description="Understand the Go daemon, Electron app, storage, and session modes." href="/architecture" />
	<Card title="Troubleshooting" description="Resolve common desktop, daemon, agent, and session problems." href="/troubleshooting" />
</Cards>
